 ...
 * @param {object} translations       - Svelte-intl translation object
 * @see https://github.com/Panya/svelte-intl#translations
 */
function addTranslations(added, translations) {
...
function create_fragment$2(ctx) {
	let if_block_anchor;
	let current;
	let if_block = /*$locale*/ ctx[1] && create_if_block$1(ctx);
...
var data$1 = { footer:"2020 - Damien Simonin Feugas",
  intuitive:"Intuitive",
...
var data = { "intuitive portable and open source":"Intuitif, portable et open source!",
...
bundles.set(defaultKey, data$1);
bundles.set('en', data$1);
bundles.set('fr', data);
...
export { query_selector_all as $, action_destroyer as A, is_function as B, tick as C, set_attributes as D, listen as E, stop_propagation as F, prevent_default as G, get_spread_update as H, bubble as I, create_component as J, claim_component as K, mount_component as L, destroy_component as M, empty as N, get_spread_object as O, group_outros as P, check_outros as Q, run_all as R, SvelteComponent as S, createEventDispatcher as T, globals as U, add_render_callback as V, create_bidirectional_transition as W, destroy_each as X, noop as Y, component_subscribe as Z, _, space as a, locale as a0, HtmlTag as a1, claim_element as b, create_slot as c, children as d, element as e, detach as f, claim_space as g, attr as h, init$1 as i, set_style as j, insert as k, append as l, transition_in as m, null_to_empty as n, transition_out as o, compute_rest_props as p, onMount as q, assign as r, safe_not_equal as s, toggle_class as t, update_slot as u, exclude_internal_props as v, binding_callbacks as w, text as x, claim_text as y, set_data as z };
